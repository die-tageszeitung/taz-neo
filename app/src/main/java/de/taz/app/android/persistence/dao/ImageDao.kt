...
abstract class ImageDao {
    ...
    @Query(
        """
        SELECT name, storageType, moTime, sha256, size, folder, type, alpha, resolution, dateDownload FROM Image INNER JOIN FileEntry ON FileEntry.name == Image.fileEntryName
