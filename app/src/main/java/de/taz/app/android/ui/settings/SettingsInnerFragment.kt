...
class SettingsInnerFragment : PreferenceFragmentCompat(), BaseContract.View {
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        findPreference<Preference>("text_night_mode")?.preferenceManager?.sharedPreferencesName =
            PREFERENCES_TAZAPICSS
        findPreference<Preference>("text_font_size")?.preferenceManager?.sharedPreferencesName =
            PREFERENCES_TAZAPICSS
